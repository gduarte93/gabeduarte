  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#prefix__b)"
        fillRule="evenodd"
        d="M153.5 130.41L40.38 197.58l146.469-9.939L198.13 39.95z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__c)"
        fillRule="evenodd"
        d="M187.089 187.54L174.5 100.65l-34.291 45.28z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__d)"
        fillRule="evenodd"
        d="M187.259 187.54L95.03 180.3l-54.16 17.091z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__e)"
        fillRule="evenodd"
        d="M41 197.41l23.04-75.48-50.7 10.841z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__f)"
        fillRule="evenodd"
        d="M140.2 146.18L119 63.14l-60.67 56.87z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__g)"
        fillRule="evenodd"
        d="M193.32 64.31l-57.35-46.84L120 69.1z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__h)"
        fillRule="evenodd"
        d="M166.5.77l-33.73 18.64L111.49.52z"
      />
      <path
        clipRule="evenodd"
        fill="url(#prefix__i)"
        fillRule="evenodd"
        d="M0 158.09l14.13-25.77-11.43-30.7z"
      />
      <path
        clipRule="evenodd"
        d="M1.94 100.65l11.5 32.62 49.97-11.211 57.05-53.02 16.1-51.139L111.209 0l-43.1 16.13C54.53 28.76 28.18 53.75 27.23 54.22c-.94.48-17.4 31.59-25.29 46.43z"
        fill="#fff"
        fillRule="evenodd"
      />
      <path
      ...
      <path
        clipRule="evenodd"
        d="M41 197.38l22.86-75.72 75.92 24.39c-27.45 25.74-57.98 47.5-98.78 51.33z"
        fill="url(#prefix__k)"
        fillRule="evenodd"
      />
      <path
        clipRule="evenodd"
        d="M120.56 68.89l19.49 77.2c22.93-24.11 43.51-50.03 53.589-82.09l-73.079 4.89z"
        fill="url(#prefix__l)"
        fillRule="evenodd"
      />
      <path
      ...
      <path
        clipRule="evenodd"
        d="M63.83 121.66l30.56 58.96c18.07-9.8 32.22-21.74 45.18-34.53l-75.74-24.43z"
        fill="url(#prefix__o)"
        fillRule="evenodd"
      />
      <path
        clipRule="evenodd"
        d="M13.35 133.19l-4.33 51.56c8.17 11.16 19.41 12.13 31.2 11.26-8.53-21.23-25.57-63.68-26.87-62.82z"
        fill="url(#prefix__p)"
        fillRule="evenodd"
      />
      <path
        clipRule="evenodd"
        d="M135.9 17.61l60.71 8.52C193.37 12.4 183.42 3.54 166.46.77L135.9 17.61z"
        fill="url(#prefix__q)"
        fillRule="evenodd"
      />
    </svg>
